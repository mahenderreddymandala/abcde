...
class Matchgame extends Component {
  ...
  componentDidMount() {
    this.timerId = setInterval(this.timersetting, 1000)
  }
  ...
  render() {
    ...
    const {activeTabId, score, imgUrl, isTrue, time} = this.state
    console.log(isTrue)
    console.log(imgUrl)
    ...
    return (
      <div className="main-container">
        <div className="m-container">
          ...
          />
          <div className="score">
            <p className="clocker">score: {score}</p>
          </div>
          <div className="timer-clock">
            ...
            />
            <p className="clocker">{time} sec</p>
          </div>
        </div>
        ...
        {!isTrue && (
          <div className="container">
            <ul className="image-section">
              <img src={imgUrl} className="random-image" alt="imageUrl" />
            </ul>
